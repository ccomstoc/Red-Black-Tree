# Red-Black-Tree
Completed this project in my junior year for a data stuctures class. It is an implementation of a red-black tree in C++. 
...
No easily readible print was created for this project, so the final trees can be found visualized in [output1Tree.png](output1Tree.png), and [output2Tree.png](output2Tree.png). 
